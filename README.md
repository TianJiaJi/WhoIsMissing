...
**Who Is Missing** 是一个轻量级的 Excel 名单比对工具，专门用于活动报名与考勤场景。只需上传"参考名单"（完整名单）和"实际名单"（报名表/签到表），即可快速识别未报名/未到人员。

### 适用场景
- 🎓 **班级活动报名** - 快速找出未报名的学生
- 🏢 **公司会议报名** - 对比应报名名单与实际报名人员
- 📋 **培训课程报名** - 自动识别未报名人员
- 🎪 **志愿者活动** - 高效管理大型活动报名情况
- ✅ **活动考勤签到** - 对比报名名单与实际签到人员
...
#### 第二步：上传实际名单  
点击"✅ 实际名单"区域，上传实际报名表或签到表。

#### 第三步：开始比对
两个文件上传完成后，点击"🔍 开始比对"按钮。

#### 第四步：查看结果
- **统计卡片** - 显示总人数、实际人数、缺失人数
- **缺失名单** - 清晰列出所有未报名/未到人员
- **全员完成** - 若无人缺失，显示"✅ 全员完成"
